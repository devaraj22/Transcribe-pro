...
# Attach the process endpoint (Speech-to-Text, subtitle download, flush)
...
# Attach the Report endpoint (PDF generation)
...
async def ping():
    ...
    return {"message": "v1 Router is active!", "version": "2.0.0"}